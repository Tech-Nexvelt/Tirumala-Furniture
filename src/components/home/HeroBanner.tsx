...
import { ArrowRight, Sparkles, Calendar, Rotate3d, ShieldCheck, Award } from "lucide-react";
...
export default function HeroBanner() {
  ...
  return (
    <>
      <section className="relative min-h-[90vh] lg:min-h-screen w-full flex items-center justify-center bg-[#FAFAF8] text-[#111827] pt-24 pb-16 overflow-hidden border-b border-[#EFEFEA]">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-7 animate-fade-in">
              {/* Luxury Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-[#EFEFEA] shadow-sm">
                <span className="w-2 h-2 rounded-full bg-[#C19A6B] animate-pulse" />
                <span className="text-[11px] font-bold tracking-[0.2em] text-[#C19A6B] uppercase">
              ...
              <h1 className="text-4xl sm:text-6xl lg:text-7xl font-serif font-bold text-[#111827] tracking-tight leading-[1.08]">
                ...
                <span className="italic font-normal text-[#C19A6B]">Defined by Luxury.</span>
              </h1>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2 text-xs text-[#111827] font-semibold">
                ...
                <div className="flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-[#00D9D9] shrink-0" />
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                <button
                  ...
                  className="px-8 py-4 rounded-xl bg-[#00D9D9] hover:bg-[#00B8B8] text-[#111827] font-bold text-xs shadow-gold hover:scale-105 transition-all uppercase tracking-wider flex items-center gap-2 cursor-pointer"
                >
                ...
                >
                  <Calendar className="w-4 h-4 text-[#C19A6B]" /> Book Showroom Visit
                </Link>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative h-[440px] sm:h-[520px] w-full rounded-3xl overflow-hidden bg-white border border-[#EFEFEA] shadow-xl group">
                <Image
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-md p-4 rounded-2xl border border-[#EFEFEA] shadow-lg flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-[#FAFAF8] text-[#C19A6B] flex items-center justify-center border border-[#EFEFEA]">
                      <Rotate3d className="w-5 h-5 animate-spin" />
                    </div>
                    <div>
                      <span className="text-[10px] font-bold text-[#C19A6B] uppercase tracking-wider block">Interactive Studio</span>
                  ...
                  <a
                    ...
                    className="px-3.5 py-2 rounded-xl bg-[#111827] text-white text-[11px] font-semibold hover:bg-[#C19A6B] transition-colors"
                  >
                    Try 3D →
                  </a>
                </div>
