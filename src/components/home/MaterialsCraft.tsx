...
export default function MaterialsCraft() {
  return (
    <section className="py-24 bg-[#0D0D0D] text-[#E8E6E1] relative overflow-hidden border-t border-[#1C1C1C]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Column: Wood Standards & Specs */}
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#C59D5F]/10 border border-[#C59D5F]/30 text-[#DFB978] text-xs font-semibold uppercase tracking-wider">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-5 rounded-2xl bg-[#1C1C1C] border border-[#C59D5F]/20 space-y-2">
                <Flame className="w-6 h-6 text-amber-400 mb-1" />
                <h4 className="font-bold text-sm text-white">Kiln-Dried to &lt;10% Moisture</h4>
              ...
              <div className="p-5 rounded-2xl bg-[#1C1C1C] border border-[#C59D5F]/20 space-y-2">
                ...
                <h4 className="font-bold text-sm text-white">10-Year Termite Guarantee</h4>
                <p className="text-xs text-gray-400 leading-relaxed">
            ...
            <div className="space-y-2.5 pt-4 border-t border-[#1C1C1C] text-xs text-gray-300">
          ...
          <div className="relative h-[480px] sm:h-[580px] w-full rounded-3xl overflow-hidden shadow-2xl border border-[#C59D5F]/30 group">
            <Image
            ...
            <div className="absolute bottom-6 left-6 right-6 p-6 rounded-2xl bg-[#0D0D0D]/90 backdrop-blur-md border border-[#C59D5F]/30 space-y-2">
              <div className="flex items-center gap-2 text-[#DFB978] font-bold text-xs uppercase tracking-wider">
                <Award className="w-4 h-4 text-[#C59D5F]" /> Heritage Wood Crafters
              </div>
