...
import { Star, Eye, Sparkles, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="bg-[#0D0D0D] text-[#E8E6E1] min-h-screen py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {/* Category Banner */}
        <div className="relative h-80 sm:h-96 w-full rounded-3xl overflow-hidden shadow-2xl border border-[#C59D5F]/30 group">
          <Image
          ...
          <div className="absolute bottom-8 left-8 right-8 max-w-2xl space-y-3">
            <span className="text-xs font-bold uppercase tracking-widest text-[#DFB978] bg-[#0D0D0D]/80 px-3.5 py-1 rounded-full border border-[#C59D5F]/30 backdrop-blur-md inline-block">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between border-b border-[#1C1C1C] pb-4">
            ...
            <span className="text-xs text-gray-400">100% Solid Teak Wood Guarantee</span>
          </div>
