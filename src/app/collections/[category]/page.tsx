  ...
  return (
    <div className="bg-[#FAFAF8] text-[#111827] min-h-screen py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {/* Category Banner */}
        <div className="relative h-80 sm:h-96 w-full rounded-3xl overflow-hidden shadow-xl border border-[#EFEFEA] group">
          <Image
          ...
          <div className="absolute bottom-8 left-8 right-8 max-w-2xl space-y-3">
            <span className="text-xs font-bold uppercase tracking-widest text-[#111827] bg-white/95 px-3.5 py-1 rounded-full border border-[#EFEFEA] backdrop-blur-md inline-block shadow-sm">
