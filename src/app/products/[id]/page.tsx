  ...
  return (
    <div className="bg-[#FAFAF8] text-[#111827] min-h-screen py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <Link
          href="/products"
          className="inline-flex items-center gap-2 text-xs font-semibold text-[#6B7280] hover:text-[#C19A6B] transition-colors"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="relative h-[450px] sm:h-[540px] w-full rounded-3xl overflow-hidden bg-white border border-[#EFEFEA] shadow-xl">
              <Image
            ...
            {product.images.length > 1 && (
              <div className="grid grid-cols-3 gap-4">
                {product.images.map((img, idx) => (
                  <div
                    key={idx}
                    className="relative h-28 w-full rounded-2xl overflow-hidden bg-white border border-[#EFEFEA]"
                  >
          ...
          <div className="lg:col-span-5 bg-white p-8 sm:p-10 rounded-3xl border border-[#EFEFEA] shadow-xl space-y-6">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-widest text-[#C19A6B]">
                  {product.roomCollection}
                </span>
                <span className="bg-[#FAFAF8] text-amber-500 font-bold text-xs px-3 py-1 rounded-full border border-amber-200 flex items-center gap-1">
            ...
            <p className="text-xs text-[#6B7280] leading-relaxed border-t border-[#EFEFEA] pt-4">
              {product.description}
            </p>

            {/* Specifications Card */}
            <div className="space-y-2 bg-[#FAFAF8] p-4 rounded-2xl border border-[#EFEFEA] text-xs">
              ...
              <div className="flex justify-between py-1 border-b border-gray-200">
                ...
                <span className="font-bold text-[#C19A6B]">{product.dimensions.length} × {product.dimensions.width}</span>
              </div>
            ...
            <div className="space-y-3 pt-4 border-t border-[#EFEFEA]">
              <a
                ...
                className="w-full py-4 rounded-xl bg-[#00D9D9] hover:bg-[#00B8B8] text-[#111827] font-bold text-xs shadow-gold hover:scale-[1.02] transition-all flex items-center justify-center gap-2 uppercase tracking-wider block text-center"
              >
